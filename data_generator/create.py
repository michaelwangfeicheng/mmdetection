...
# Helper functions
def get_obj_positions(obj, bkg, count=1,sizes = [0.4, 0.6, 0.8, 1, 1.2]):
    obj_w, obj_h = [], []
...
if __name__ == "__main__":
    ...
    parser.add_argument("-bkg", "--backgrounds", type=str, default="data/Backgrounds/",
                        help="Path to background images folder.")
    parser.add_argument("-obj", "--objects", type=str, default="data/Objects/",
                        help="Path to object images folder.")
    parser.add_argument("-o", "--output", type=str, default="data/TrainingImages/",
