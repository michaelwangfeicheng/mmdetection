...
def parse_args():
    ...
    parser.add_argument("--root",default="data/Objects/seal",
      help="The root directory which contains the images and annotations.")
    parser.add_argument("--exp",default="data/output_dir",
    ...
    parser.add_argument("--num",
      help="Number of times each image will be in dataset", default=3, type=int)
